    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v){
                b.putString("pla" , r1.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla" , r2.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r3.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick (View v){
                b.putString("pla" , r3.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();         }
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla" , r5.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla" , r6.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla" , r7.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla" , r8.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla" , r4.getText().toString());
                ini = new Intent(Primer.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
