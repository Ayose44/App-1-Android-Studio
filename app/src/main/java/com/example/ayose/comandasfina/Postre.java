...
public class Postre extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.postre);
        ...
        r1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v){
                b.putString("pla3" , r1.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla3" , r2.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r3.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick (View v){
                b.putString("pla3" , r3.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();         }
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla3" , r5.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla3" , r6.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla3" , r7.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla3" , r8.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("pla3" , r4.getText().toString());
                ini = new Intent(Postre.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
