    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v){
                b.putString("beb" , r1.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("beb" , r2.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r3.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick (View v){
                b.putString("beb" , r3.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();         }
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("beb" , r5.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("beb" , r6.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("beb" , r7.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("beb" , r8.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                b.putString("beb" , r4.getText().toString());
                ini = new Intent(Bebida.this,MainActivity.class);
                ini.putExtras(b);
                startActivity(ini);
                finish();
